export default function (config) {
  const role_id = config.data.role_id;
  return {
    role_id,
    module: {
      module_elem_set: [
          ...
          feature_set: [
            {
              ...
              checked_action_bundle_id_set: ['m4.f1.a6', 'm4.f1.a5', 'm4.f1.a1']
            },
            {
              feature_id: 'm4.f2',
              feature_name: '角色管理',
          ...
          feature_set: [
            {
              ...
              checked_action_bundle_id_set: ['m5.f2.a2']
            }
          ],
          data_level: 'all',
          is_check_all: true
        },
        {
          ...
          feature_set: [
            ...
            },
            {
              ...
              checked_action_bundle_id_set: ['m6.f2.a1', 'm6.f2.a3', 'm6.f2.a4']
            }
          ],
          data_level: 'all',
          is_check_all: true
          ...
          feature_set: [
            {
              ...
              checked_action_bundle_id_set: ['m8.f2.a2']
            }
          ],
          data_level: 'all',
          is_check_all: true
        },
        {
          ...
          feature_set: [
            ...
            },
            {
              ...
              checked_action_bundle_id_set: ['m1.f3.a2', 'm1.f3.a4', 'm1.f3.a3']
            }
          ],
          data_level: 'all',
          is_check_all: true
          ...
          feature_set: [
            {
              ...
              checked_action_bundle_id_set: ['isv_auth']
            }
          ],
          data_level: 'all',
          is_check_all: true
