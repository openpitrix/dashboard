...
import * as Manage from 'containers/Manage';
...
const routes = [
  ...
  { path: '/manage/overview', exact: true, component: Manage.Overview },
  ...
  { path: '/manage/addruntime', exact: true, component: Manage.RuntimeAdd },
  { path: '/manage/repos', exact: true, component: Manage.Repos },
  { path: '/manage/repos/:repoId', exact: true, component: Manage.RepoDetail },
  { path: '/manage/addrepo', exact: true, component: Manage.RepoAdd },
